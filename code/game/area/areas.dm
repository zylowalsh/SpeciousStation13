...
/area/Entered(A)
	...
	if(prob(35))
		...
		if(istype(src, /area/civ/chapel))
			...
			sound = pick('sound/ambience/ambispace.ogg','sound/music/title2.ogg')
		...
		else if(istype(src, /area/turret_protected/ai) || istype(src, /area/turret_protected/ai_upload) || istype(src, /area/turret_protected/ai_upload_foyer))
