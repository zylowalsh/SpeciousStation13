...
/datum/game_mode
	var/name = "invalid"
	var/config_tag = null
	var/canShuttleBeCalled = TRUE
	var/messageWhenShuttleIsDenied = "ERROR: No one set messageWhenShuttleIsDenied for this gamemode!"
	var/canShuttleBeRecalled = TRUE
	var/shuttleFakedCalled = FALSE
...
/datum/game_mode/proc/check_finished() //to be called by ticker
	if(emergencyShuttle.shuttleState == RETURNED_FROM_STATION || station_was_nuked)
		return 1
	return 0
