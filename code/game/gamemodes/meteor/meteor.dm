...
/datum/game_mode/meteor/post_setup()
	deferPowernetRebuild = 2//Might help with the lag
	...
	for(var/mob/living/player in player_list)
		if(player.stat != DEAD)
			...
			switch(location.loc.type)
				...
				if( /area/shuttle/escape_pod1/centcom, /area/shuttle/escape_pod2/centcom, /area/shuttle/escape_pod3/centcom,/area/shuttle/escape_pod4/centcom , /area/shuttle/escape_pod5/centcom )
