...
/datum/game_mode/anti_revolution/announce()
	...
	world << "<B>Looks like [HEADQUARTERS_NAME] has given a few new orders..</B>"
...
/datum/game_mode/proc/greet_head(var/datum/mind/head_mind, var/you_are=1)
	var/obj_count = 1
	if (you_are)
		head_mind.current << "\blue It looks like this shift [HEADQUARTERS_NAME] has some special orders for you.. check your objectives."
...
/datum/game_mode/anti_revolution/declare_completion()
	...
	if(finished == 2)
		...
		world << "\red <FONT size = 3><B> The heads of staff managed to meet the goals set for them by [HEADQUARTERS_NAME]!</B></FONT>"
