//Config stuff
var/const/SPECOPS_MOVETIME = 600	//Time to station is milliseconds. 60 seconds, enough time for everyone to be on the shuttle before it leaves.
var/const/SPECOPS_STATION_AREATYPE = "/area/shuttle/specops/station" //Type of the spec ops shuttle area for station
var/const/SPECOPS_DOCK_AREATYPE = "/area/shuttle/specops/centcom"	//Type of the spec ops shuttle area for dock
var/const/SPECOPS_RETURN_DELAY = 6000 //Time between the shuttle is capable of moving.
...
/proc/specops_return()
	...
	var/area/start_location = locate(/area/shuttle/ert/station)
	var/area/end_location = locate(/area/shuttle/ert/centcom)
...
//		announcer.autosay(message, "A.L.I.C.E.", "Response Team")
	...
	var/area/start_location = locate(/area/shuttle/ert/centcom)
	var/area/end_location = locate(/area/shuttle/ert/station)
