//Config stuff
var/const/SYNDICATE_ELITE_MOVETIME = 600	//Time to station is milliseconds. 60 seconds, enough time for everyone to be on the shuttle before it leaves.
var/const/SYNDICATE_ELITE_STATION_AREATYPE = "/area/shuttle/syndicate_elite/station" //Type of the spec ops shuttle area for station
var/const/SYNDICATE_ELITE_DOCK_AREATYPE = "/area/shuttle/syndicate_elite/mothership"	//Type of the spec ops shuttle area for dock
