var/const/MALFUNCTION_TEMPORARY = 1
var/const/MALFUNCTION_PERMANENT = 2
	...
	activate(var/cause)
		...
		switch (cause)
			if("death")
				...
				if(istype(t, /area/shuttle/syndicate) || istype(t, /area/syndicate_mothership) || istype(t, /area/shuttle/syndicate_elite) )
