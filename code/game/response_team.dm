...
client/verb/JoinResponseTeam()
	...
	/*	if(admin_emergency_team)
		...
		for (var/obj/effect/landmark/L in landmarks_list) if (L.name == "Commando")
			...
			new_commando << "\blue You are [!leader_selected?"a member":"the <B>LEADER</B>"] of an Emergency Response Team, a type of military division, under [HEADQUARTERS_NAME]'s service. There is a code red alert on [station_name()], you are tasked to go and fix the problem."
			...
			if(!leader_selected)
				new_commando << "<b>As member of the Emergency Response Team, you answer only to your leader and [HEADQUARTERS_NAME] officials.</b>"
			else
				new_commando << "<b>As leader of the Emergency Response Team, you answer only to [HEADQUARTERS_NAME] officials. You have authority to override the Captain where it is necessary to achieve your mission goals.  However, it is recommended that you attempt to cooperate with the captain where possible."
			return
