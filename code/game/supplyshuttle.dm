//Config stuff
var/const/SUPPLY_DOCKZ = 2          //Z-level of the Dock.
var/const/SUPPLY_STATIONZ = 1       //Z-level of the Station.
var/const/SUPPLY_STATION_AREATYPE = "/area/supply/station" //Type of the supply shuttle area for station
var/const/SUPPLY_DOCK_AREATYPE = "/area/supply/dock"	//Type of the supply shuttle area for dock
