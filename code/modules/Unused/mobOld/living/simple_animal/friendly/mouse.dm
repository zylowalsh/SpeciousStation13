/mob/living/simple_animal/mouse
	...
	density = 0
	var/fur_color //brown, gray and white, leave blank for random
	layer = MOB_LAYER
...
/mob/living/simple_animal/mouse/Life()
	...
	if(!ckey && stat == CONSCIOUS && prob(0.5))
		stat = UNCONSCIOUS
		icon_state = "mouse_[fur_color]_sleep"
		wander = 0
		speak_chance = 0
		//snuffles
...
/mob/living/simple_animal/mouse/New()
	..()
	if(!fur_color)
		fur_color = pick( list("brown","gray","white") )
	icon_state = "mouse_[fur_color]"
	icon_living = "mouse_[fur_color]"
	icon_dead = "mouse_[fur_color]_dead"
	desc = "It's a small [fur_color] rodent, often seen hiding in maintenance areas and making a nuisance of itself."


/mob/living/simple_animal/mouse/proc/splat()
	src.health = 0
	src.stat = DEAD
	src.icon_dead = "mouse_[fur_color]_splat"
	src.icon_state = "mouse_[fur_color]_splat"
	if(client)
