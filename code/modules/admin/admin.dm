...
/datum/admins/proc/Secrets()
	...
	var/dat = "<B>Secrets... that aren't that secret.</B><HR>"
	...
	if(check_rights(R_ADMIN,0))
		dat += {"
			...
			/* Lines from above that don't work
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<BR>
			<A href='?src=\ref[src];secretsfun=gravity'>Toggle the station artificial gravity</A><BR>
