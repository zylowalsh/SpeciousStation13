var/const/MEMOFILE = "data/memo.sav"	//where the memos are saved
var/const/ENABLE_MEMOS = 1				//using a define because screw making a config variable for it. This is more efficient and purty.
