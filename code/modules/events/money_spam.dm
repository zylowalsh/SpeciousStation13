		...
		if(prob(2))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(4)
					...
					"Dr. Maxman was created by George Acuilar, M.D, a [HEADQUARTERS_NAME] Certified Urologist who has treated over 70,000 patients sector wide with 'male problems'.",\
